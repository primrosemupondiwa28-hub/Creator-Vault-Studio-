...
import { Camera, ShoppingBag, Shirt, Lightbulb, Smartphone, Star, Quote, MessageSquareText, ArrowRight, Sparkles, Layers } from 'lucide-react';
...
export const Home: React.FC<HomeProps> = ({ onNavigate }) => {
  ...
  const reviews = [
    ...
    },
    {
      name: "Yuna Kim",
      handle: "@yuna_digital",
      image: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?auto=format&fit=crop&q=80&w=200&h=200", // Asian woman
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] w-full bg-luxury-950">
      ...
      <div className="relative pt-20 pb-24 flex flex-col items-center justify-center text-center px-4 bg-gradient-to-b from-luxury-900 to-luxury-950 border-b border-brand-900/30">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <div className="flex items-center gap-2 mb-6 px-4 py-1.5 bg-brand-900/50 border border-brand-500/20 rounded-full backdrop-blur-sm">
             ...
             <span className="text-xs font-bold text-brand-200 tracking-widest uppercase">Generative AI Suite V2.0</span>
          </div>
      ...
      {/* Main Studio Grid - Clean separation */}
